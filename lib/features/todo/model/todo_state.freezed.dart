...
abstract class $TodoStateCopyWith<$Res> {
  ...
  $Res call({bool isLoading, List<Todo> todoItems});
}
...
class _$_TodoState with DiagnosticableTreeMixin implements _TodoState {
  const _$_TodoState(
      {this.isLoading = false, final List<Todo> todoItems = const []})
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TodoState(isLoading: $isLoading, todoItems: $todoItems)';
  }
...
abstract class _TodoState implements TodoState {
  const factory _TodoState({final bool isLoading, final List<Todo> todoItems}) =
      _$_TodoState;
